 ...
 */
class WP_REST_Template_Controller extends WP_REST_Controller {
	/**
	 * Post type.
	 *
	 * @since 4.7.0
	...
	public function get_featured_cards_data($query_args){
		...
		$enable = isset($settings['enable_cand_rand']) ? $settings['enable_cand_rand'] : 'no' ; 
		...
		if(isset($query_args['tax_query'])){
			...
			$max_featured_count = isset($settings['featured_count_cat']) ? $settings['featured_count_cat'] : 3 ; 
		}
		
		$query_args['posts_per_page'] = $max_featured_count ; 
